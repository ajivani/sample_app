...
describe User do
  ...
  describe "relationships" do
    ...
    it 'should have a follow! mehtod' do
      @user.should respond_to(:follow!)
    end
    it 'should follow another user' do
      @user.follow!(@followed)
      @user.should be_following(@followed) #@user.following?(@followed).should be_true
    end
    it' should include the followed user in the following (ie the user.following) array' do
      @user.follow!(@followed)
