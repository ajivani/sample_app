...
describe "PUT 'update'" do
    ...
    describe "failure" do
      ...
      it "it should render the 'edit' page" do
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for non-signed users" do
      it "should deny access to teh edit fucntion" do
        get :edit, :id=>@user
        response.should redirect_to(signin_path)
      end
      it "should deny access to the update function" do
        put :update, :id=>@user, :user=>{}
        response.should redirect_to(signin_path)
      end
    end #NOT signed in users
  ...
  describe "GET 'index'" do
    ...
    end#non sginged in users

    describe "signed in users" do
      before(:each) do 
        @user = test_sign_in(Factory(:user))
        second = Factory(:user, :email=>'anohteremail2@example.com')
        third = Factory(:user, :email=>'anotheremail3@example.co.uk')
